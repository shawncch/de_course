...
df_result.write.format('bigquery')\
    .option('table', output)\
    .option('temporaryGcsBucket', 'dataproc-temp-asia-southeast1-647357588616-qkxrlbil')\
    .save()
...
#         --green_input=gs://dtc-de-course-464416-demo-bucket/pq/green/2020 \
#         --yellow_input=gs://dtc-de-course-464416-demo-bucket/pq/yellow/2020 \
#         --output=gs://dtc-de-course-464416-demo-bucket/report-test/


# gcloud dataproc jobs submit pyspark \
#     gs://dtc-de-course-464416-demo-bucket/code/own_local_cluster_dataproc.py \
#     --cluster=dataproc-test  \
#     --region=asia-southeast1
#     -- \
#         --green_input=gs://dtc-de-course-464416-demo-bucket/pq/green/2021 \
#         --yellow_input=gs://dtc-de-course-464416-demo-bucket/pq/yellow/2021 \
#         --output=gs://dtc-de-course-464416-demo-bucket/report-2021/

# gcloud dataproc jobs submit pyspark \
#     gs://dtc-de-course-464416-demo-bucket/code/own_local_cluster_dataproc_bq.py \
#     --cluster=dataproc-test \
#     --region=asia-southeast1 \
#     -- \
#         --green_input=gs://dtc-de-course-464416-demo-bucket/pq/green/2021 \
#         --yellow_input=gs://dtc-de-course-464416-demo-bucket/pq/yellow/2021 \
#         --output=test.report-2021